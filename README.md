...
* we can use this project to detect the presence of garbage around our surroundings like plastic bags.
...
Project Link: [https://github.com/jap-patel/Garbage_detection](https://github.com/jap-patel/Garbage_detection)
